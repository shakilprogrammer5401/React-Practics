...
const IncDecState = () => {
 const [update, setUpdate] = useState(0)
  ...
  <button onClick={()=>setUpdate(update - 1)} className="py-2 px-4 bg-black text-white rounded-full border border-green-400 over:bg-red-600 hover:text-white  transition-all duration-150 ms-10 text-xl ">Decrement -  </button>
